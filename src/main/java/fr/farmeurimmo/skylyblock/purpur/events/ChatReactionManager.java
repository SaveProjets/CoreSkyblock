package fr.farmeurimmo.skylyblock.purpur.events;
...
public class ChatReactionManager {
    ...
    private final List<String> chatReactions = new ArrayList<>(List.of("Farmeurimmo", "SkylyBlock", "VeryMc"));
    ...
    public ChatReactionManager() {
        ...
        Bukkit.getScheduler().runTaskLater(SkylyBlock.INSTANCE, this::startChatReaction, 20L * 120L);
    }
    ...
    public void startChatReaction() {
        ...
        Bukkit.getScheduler().runTaskLaterAsynchronously(SkylyBlock.INSTANCE, () -> {
            if (isRunning) {
                isRunning = false;
                startChatReaction();
            }
