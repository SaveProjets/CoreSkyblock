...
public enum Enchantments {
    ...
    DECAPITEUR("Décapiteur", "§7Quand on tue un joueur avec une épée avec l’enchantement, il y a {value}% que la tête du joueur tuée drop au sol",
            4, true, 0.025, 1, 0, -1,
    ...
    FLECHE_GELEE("Flèche gelée", "§7Chance de {value}% de paralyser l'ennemi (effet de slowness extrêmement important) durant {value_effect} secondes.",
            3, true, 0.03, 0.5, 0, 2,
